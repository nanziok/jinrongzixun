...
Source Host           : 8.140.125.202:3306
Source Database       : app_com

Target Server Type    : MYSQL
Target Server Version : 50650
File Encoding         : 65001

Date: 2021-04-19 09:47:19
*/
...
CREATE TABLE `ke_account_log` (
  ...
  `relative_id` int(10) DEFAULT '0' COMMENT '相关ID 订单 推荐人ID等',
  `money` decimal(10,2) DEFAULT '0.00' COMMENT '变动金额',
  `all_money` decimal(10,2) DEFAULT '0.00' COMMENT '总金额',
  `jifen` int(10) DEFAULT '0' COMMENT '变动积分',
  `all_jifen` int(10) DEFAULT '0' COMMENT '总积分',
  `jinbi` int(10) DEFAULT '0' COMMENT '变动金币',
  `all_jinbi` int(10) DEFAULT '0' COMMENT '总金币',
  `change_time` int(10) DEFAULT '0',
  `change_desc` varchar(100) DEFAULT NULL COMMENT '变动类型',
  `change_type` tinyint(2) DEFAULT '0' COMMENT '0后台调节 1积分兑换 2宠物生产 3 邀请赠送积分 5金币资金兑换 6提现 7拼团订单退款 8普通订单退款 9普通订单返积分',
  PRIMARY KEY (`log_id`)
...
-- ----------------------------
-- Table structure for ke_anli
-- ----------------------------
DROP TABLE IF EXISTS `ke_anli`;
CREATE TABLE `ke_anli` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) DEFAULT NULL COMMENT '案例名称',
  `img` varchar(100) DEFAULT NULL COMMENT '缩略图',
  `content` text,
  `add_time` int(10) DEFAULT '0' COMMENT '添加时间',
  `status` tinyint(1) DEFAULT '1' COMMENT '1显示2隐藏',
  `listorder` mediumint(5) DEFAULT '50' COMMENT '排序',
  PRIMARY KEY (`id`)
...
-- Records of ke_anli
-- ----------------------------
INSERT INTO `ke_anli` VALUES ('1', '眼部护理的重要性', '/uploads/image/20210406/606bbd2427776.jpg', '<p style=\"text-align: center;\"><strong>眼部护理的重要性</strong></p><p>1、眼部皮肤非常薄，只有0.33-0.36mm，是面部肌肤的1/4厚，非常的脆弱。</p><p>2、运动量大，每天每人约眨眼2万次，易疲劳。</p><p>3、眼部皮肤水份蒸发速度快，是面部水份蒸发速度的2倍。</p><p>4、眼部皮肤只有少量的皮脂腺和汗腺，不能形成皮脂腺，从而眼部皮肤没有保护膜易受损。</p><p>5、眼部循环系统非常细小，易造成循环代谢减慢，而形成眼部问题。</p><p style=\"text-align: center;\"><strong>眼球结构</strong></p><p style=\"text-align: center;\"><img src=\"/uploads/image/20210406/1617673457826836.jpg\"/></p><p><br/></p><br/><p><br/></p>', '1617673510', '1', '1');
INSERT INTO `ke_anli` VALUES ('2', '见证历史：谷歌与甲骨文十年版权之争落幕，抄袭代码不侵权', '/uploads/image/20210406/606bbdea63b63.jpg', '<p><span style=\"color: #333333; --tt-darkmode-color: #A3A3A3;\">最初谷歌曾宣称这37个API不具有版权。后来又辩解，这类代码通常被开发者自由使用，以提高不同产品之间的互操作性，即使此类代码具有如甲骨文所声称的版权，也应当包括在法律的“合理使用”条款中，该条款允许在某些情况下未经许可使用其他版权保护的素材。</span></p><p><span style=\"color: #333333; --tt-darkmode-color: #A3A3A3;\">但是甲骨文却认为，该API代码是受版权保护的，因此谷歌应该为此付费，虽然某些标准代码不受保护，但Java代码绝不是标准代码。</span></p><p><span style=\"color: #333333; --tt-darkmode-color: #A3A3A3;\">无论是谷歌还是甲骨文，都认为自己才是创新的真正拥护者。谷歌认为，对API实施严格的版权保护会让哪些本来使用共享代码构建的额开发人员感到寒心，因此不利于创新者，也减缓了新产品的开发过程，对消费者不利。而甲骨文则认为，如果谷歌在本案中获胜，则会阻止软件开发人员在软件上继续进行投资，因为他们知道由此产生的代码可以被其他人无偿使用。</span></p><p><span style=\"color: #333333; --tt-darkmode-color: #A3A3A3;\">对于这一点，虽然美国科技界的巨头公司可能会站在谷歌一方，认为该裁决促进了创新、竞争和，但是鲜明反对的声音依然存在。</span></p><p><span style=\"color: #333333; --tt-darkmode-color: #A3A3A3;\">知名IP博主Florian Mueller就表示，这一决定对软件开发者而言绝对是一个坏消息，虽然“合理使用”是不违法的，但是过度的合理使用将导致侵权行为的发生。</span></p><p><span style=\"color: #333333; --tt-darkmode-color: #A3A3A3;\">甚至在探讨软件知识产权保护形式上，对现有的专利（偏技术）和版权（偏代码）之外，是否还需要出现一个中间的知识产权保护手段都进行了探讨。并且引申到了外部的软件的版权保护和依赖版权的软件许可证问题。</span></p><p><span style=\"color: #333333; --tt-darkmode-color: #A3A3A3;\">足见这起案件对全球软件行业未来知识产权保护形势具有深远的影响，相信该案件会成为未来一段时间热议的焦点。对中国的软件开发者也具有一个非常重要的借鉴意义。</span></p><p><br/></p>', '1617673725', '1', '2');
...
CREATE TABLE `ke_article` (
  ...
  `cat_id` mediumint(5) DEFAULT '0' COMMENT '文章分类',
  `title` varchar(250) DEFAULT NULL COMMENT '标题',
  `content` longtext,
  `add_time` int(11) DEFAULT '0' COMMENT '添加时间',
  `is_show` tinyint(1) DEFAULT '1' COMMENT '1显示2不显示',
  `listorder` mediumint(5) DEFAULT '50' COMMENT '排序',
  PRIMARY KEY (`id`),
  KEY `cat` (`cat_id`)
...
CREATE TABLE `ke_article_cat` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL COMMENT '文章分类名称',
  `desc` varchar(255) DEFAULT NULL COMMENT '类目描述',
  `add_time` int(11) DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `ke_article_cat` VALUES ('1', '系统文章', '不可删除', '1615532626');
INSERT INTO `ke_article_cat` VALUES ('2', '系统公告', '不可删除', '1617344248');
...
CREATE TABLE `ke_guanggao` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `cat_id` mediumint(5) DEFAULT '0' COMMENT '广告分类ID',
  `title` varchar(100) DEFAULT NULL COMMENT '广告标题',
  `img` varchar(100) DEFAULT NULL,
  `add_time` int(10) DEFAULT '0' COMMENT '添加时间',
  `listorder` mediumint(5) DEFAULT '0' COMMENT '排序',
  `type` tinyint(2) DEFAULT '0' COMMENT '广告链接类型1菜单链接 2案例 3网点  6外链',
  `url` varchar(100) DEFAULT NULL,
  `is_show` tinyint(2) DEFAULT '1' COMMENT ' 1显示 2不显示',
  `is_login` tinyint(2) DEFAULT '2' COMMENT '1需要登录 2不需要登录',
  PRIMARY KEY (`id`)
...
CREATE TABLE `ke_region` (
  ...
  `str` varchar(2) DEFAULT NULL COMMENT '首字母',
...
CREATE TABLE `ke_service` (
  ...
  `phone` varchar(50) DEFAULT NULL COMMENT '门店电话',
...
-- ----------------------------
-- Table structure for ke_shipping
-- ----------------------------
DROP TABLE IF EXISTS `ke_shipping`;
CREATE TABLE `ke_shipping` (
  `shipping_id` int(20) unsigned NOT NULL AUTO_INCREMENT,
  `shipping_name` varchar(50) NOT NULL,
  `shipping_desc` varchar(100) DEFAULT NULL,
...
-- ----------------------------
-- Records of ke_shipping
-- ----------------------------
INSERT INTO `ke_shipping` VALUES ('14', '申通快递', '申通快递设置', 'shentong', '1552629171');
INSERT INTO `ke_shipping` VALUES ('13', '圆通快递', '圆通快递', 'yuantong', '1570628118');
INSERT INTO `ke_shipping` VALUES ('22', '天天快递', '', 'tiantian', '1552653561');
INSERT INTO `ke_shipping` VALUES ('21', '顺丰快递', '', 'shunfeng', '1552653539');
INSERT INTO `ke_shipping` VALUES ('23', '德邦物流', '', 'debang', '1552701922');
INSERT INTO `ke_shipping` VALUES ('25', '中通快递', '', 'zhongtong', '1552907726');
INSERT INTO `ke_shipping` VALUES ('27', '百世快递', 'fadvbdfvbdfxb', 'baishi', '1557281855');
INSERT INTO `ke_shipping` VALUES ('28', '韵达快递', '', 'yunda', '1564218619');

-- ----------------------------
-- Table structure for ke_shipping_area
-- ----------------------------
DROP TABLE IF EXISTS `ke_shipping_area`;
CREATE TABLE `ke_shipping_area` (
  `shipping_area_id` int(11) NOT NULL AUTO_INCREMENT,
  `shipping_id` int(11) NOT NULL,
  `price` decimal(10,2) DEFAULT '0.00',
  `name` varchar(50) DEFAULT NULL COMMENT '配送区域备注信息',
  `add_time` int(11) DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`shipping_area_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ke_shipping_area
-- ----------------------------
INSERT INTO `ke_shipping_area` VALUES ('17', '13', '0.00', '全国', '1570633208');
INSERT INTO `ke_shipping_area` VALUES ('18', '13', '0.00', '南方', '1570674033');

-- ----------------------------
-- Table structure for ke_shipping_area_region
-- ----------------------------
DROP TABLE IF EXISTS `ke_shipping_area_region`;
CREATE TABLE `ke_shipping_area_region` (
  `shipping_area_id` int(11) NOT NULL,
  `region_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ke_shipping_area_region
-- ----------------------------
INSERT INTO `ke_shipping_area_region` VALUES ('17', '1');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '2');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '3');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '4');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '5');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '6');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '7');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '8');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '9');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '10');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '11');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '12');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '13');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '14');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '15');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '16');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '17');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '18');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '19');
INSERT INTO `ke_shipping_area_region` VALUES ('18', '20');
...
CREATE TABLE `ke_user` (
  ...
  `shili` tinyint(1) DEFAULT '0' COMMENT '视力状态1近视2远视3弱视4散光5其他',
  `tiaoli` tinyint(1) DEFAULT '0' COMMENT '调理进度1234',
  `school` varchar(100) DEFAULT NULL COMMENT '学校',
  `banji` varchar(100) DEFAULT NULL COMMENT '班级',
  `desc` varchar(200) DEFAULT NULL COMMENT '简介',
  `province` smallint(5) DEFAULT '0' COMMENT '省份',
  `city` smallint(5) DEFAULT '0' COMMENT '城市',
  `district` smallint(5) DEFAULT '0' COMMENT '县区',
  `fabu` int(10) DEFAULT '0' COMMENT '发布数',
  `guanzhu` int(10) DEFAULT '0' COMMENT '关注数',
  `fensi` int(10) DEFAULT '0' COMMENT '粉丝数',
  `zan` int(10) DEFAULT '0' COMMENT '点赞数',
  `get_zan` int(10) DEFAULT '0' COMMENT '获赞数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
-- Records of ke_user
-- ----------------------------
INSERT INTO `ke_user` VALUES ('1', null, '1', 'f379eaf3c831b04de153469d1bec345e', '1618795443', '18888888888', '/uploads/head/20210419/3de68af8f8e1676f9cd5e084a0d83e9d.jpg', '赞多', '力丸', '1', '20', '1', '2', null, null, null, '11', '149', '1253', '0', '0', '1', '0', '0');
INSERT INTO `ke_user` VALUES ('2', null, '1', 'f379eaf3c831b04de153469d1bec345e', '1618795778', '18686868686', '/uploads/head/20210419/3aa60672dffef6496437268cab6e7f57.jpg', '小九', '丫丫', '2', '18', '4', '1', null, null, null, '11', '149', '1253', '0', '1', '0', '0', '0');
...
CREATE TABLE `ke_user_admin` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_cat` mediumint(9) DEFAULT '0' COMMENT '角色ID',
...
CREATE TABLE `ke_user_admin_action` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `fid` int(20) DEFAULT '0' COMMENT '上级',
  `m` varchar(20) DEFAULT NULL COMMENT '控制器',
  `a` varchar(20) DEFAULT NULL COMMENT '方法',
  `name` varchar(255) DEFAULT NULL COMMENT '菜单名称',
  `listorder` mediumint(5) DEFAULT '50' COMMENT '排序',
  `icon` varchar(50) DEFAULT NULL,
  `is_show` tinyint(1) DEFAULT '1' COMMENT '1 显示 0不显示',
  PRIMARY KEY (`id`)
...
INSERT INTO `ke_user_admin_action` VALUES ('157', '15', 'User', 'Fabu', '会员发布', '50', '', '1');
INSERT INTO `ke_user_admin_action` VALUES ('194', '15', 'User', 'fabu_del_list', '发布删除', '50', '', '1');
...
INSERT INTO `ke_user_admin_action` VALUES ('193', '192', 'Anli', 'index', '案例列表', '1', '', '1');
...
INSERT INTO `ke_user_admin_action` VALUES ('192', '0', 'Anli', 'index', '案例管理', '10', 'icon02', '1');
INSERT INTO `ke_user_admin_action` VALUES ('195', '192', 'Anli', 'anli_add', '案例添加', '50', '', '1');
INSERT INTO `ke_user_admin_action` VALUES ('196', '0', 'Service', 'index', '服务点管理', '12', 'iconicon', '1');
INSERT INTO `ke_user_admin_action` VALUES ('197', '0', 'Tousu', 'index', '投诉管理', '16', 'icontousu', '1');
INSERT INTO `ke_user_admin_action` VALUES ('198', '196', 'Service', 'service_add', '服务点添加', '50', '', '1');
INSERT INTO `ke_user_admin_action` VALUES ('199', '196', 'Service', 'index', '服务点列表', '10', '', '1');
...
INSERT INTO `ke_user_admin_auth` VALUES ('1', '157');
...
INSERT INTO `ke_user_admin_auth` VALUES ('1', '192');
INSERT INTO `ke_user_admin_auth` VALUES ('1', '193');
INSERT INTO `ke_user_admin_auth` VALUES ('1', '194');
INSERT INTO `ke_user_admin_auth` VALUES ('1', '195');
INSERT INTO `ke_user_admin_auth` VALUES ('1', '196');
...
-- ----------------------------
-- Table structure for ke_user_fabu
-- ----------------------------
DROP TABLE IF EXISTS `ke_user_fabu`;
CREATE TABLE `ke_user_fabu` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户ID',
  `type` tinyint(1) DEFAULT '3' COMMENT '1图片2视频 3纯文本',
  `type_value` varchar(200) DEFAULT NULL COMMENT '类型值图片是，拼接的字符串',
  `video` varchar(200) DEFAULT NULL COMMENT '视频地址',
  `content` varchar(500) DEFAULT NULL COMMENT '内容',
  `add_time` int(10) DEFAULT '0' COMMENT '添加时间',
  `status` tinyint(1) DEFAULT '2' COMMENT '1正常2审核中',
  `is_delete` tinyint(1) DEFAULT '0' COMMENT '0正常 1提交删除',
  `zan` int(10) DEFAULT '0' COMMENT '点赞数',
...
-- ----------------------------
-- Records of ke_user_fabu
-- ----------------------------

-- ----------------------------
-- Table structure for ke_user_fabu_comment
-- ----------------------------
DROP TABLE IF EXISTS `ke_user_fabu_comment`;
CREATE TABLE `ke_user_fabu_comment` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `fabu_id` int(10) NOT NULL DEFAULT '0' COMMENT '信息ID',
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '评论人ID',
  `content` varchar(100) DEFAULT NULL COMMENT '评论内容',
  `pid` int(10) DEFAULT '0' COMMENT '评论的上级ID',
  `add_time` int(10) DEFAULT '0' COMMENT '评价时间',
  `is_read` tinyint(1) DEFAULT '0' COMMENT '0未读1已读',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ke_user_fabu_comment
-- ----------------------------

-- ----------------------------
-- Table structure for ke_user_guanzhu
-- ----------------------------
DROP TABLE IF EXISTS `ke_user_guanzhu`;
CREATE TABLE `ke_user_guanzhu` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) DEFAULT '0' COMMENT '用户Id',
  `relative_id` int(10) DEFAULT '0' COMMENT '关联ID',
  `add_time` int(10) DEFAULT '0' COMMENT '关注时间',
  `is_read` tinyint(1) DEFAULT '0' COMMENT '0未读1已读',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `relative_id` (`relative_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ke_user_guanzhu
-- ----------------------------
INSERT INTO `ke_user_guanzhu` VALUES ('3', '2', '1', '1618796611', '0');

-- ----------------------------
-- Table structure for ke_user_rank
-- ----------------------------
DROP TABLE IF EXISTS `ke_user_rank`;
CREATE TABLE `ke_user_rank` (
...
-- ----------------------------
-- Records of ke_user_rank
-- ----------------------------
INSERT INTO `ke_user_rank` VALUES ('1', '银卡会员');
INSERT INTO `ke_user_rank` VALUES ('2', '金卡会员');
INSERT INTO `ke_user_rank` VALUES ('3', '黑卡会员');
...
CREATE TABLE `ke_user_yijian` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) DEFAULT '0' COMMENT '用户ID',
  `content` varchar(200) DEFAULT NULL COMMENT '意见内容',
  `phone` varchar(20) DEFAULT NULL COMMENT '联系方式',
  `img` varchar(200) DEFAULT NULL COMMENT '图片',
  `add_time` int(10) DEFAULT '0' COMMENT '添加时间',
  `mark` varchar(200) DEFAULT NULL COMMENT '备注信息',
  `status` tinyint(1) DEFAULT '1' COMMENT '1未处理2已处理',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for ke_user_zan
-- ----------------------------
DROP TABLE IF EXISTS `ke_user_zan`;
CREATE TABLE `ke_user_zan` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) DEFAULT '0',
  `fabu_id` int(10) DEFAULT '0' COMMENT '发布ID',
  `add_time` int(10) DEFAULT '0' COMMENT '点赞时间',
  `is_read` tinyint(1) DEFAULT '0' COMMENT '0未读1已读',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ke_user_zan
-- ----------------------------
...
CREATE TABLE `ke_xitong` (
  ...
  `name` varchar(250) DEFAULT NULL COMMENT '系统名称',
  `phone` varchar(20) DEFAULT NULL COMMENT '客服电话',
  `android` varchar(20) DEFAULT NULL COMMENT '安卓版本号',
  `android_url` varchar(100) DEFAULT NULL COMMENT '安卓下载链接',
  `ios` varchar(20) DEFAULT NULL COMMENT 'ios版本号',
  `ios_url` varchar(100) DEFAULT NULL COMMENT 'ios下载链接',
  `gengxin_desc` varchar(200) DEFAULT NULL COMMENT '更新提示语',
  `app` tinyint(1) DEFAULT '2' COMMENT '1正常2关闭',
  `app_desc` varchar(100) DEFAULT NULL,
  `msg_zhanghao` varchar(50) DEFAULT NULL COMMENT '互亿无线账号',
  `msg_secret` varchar(100) DEFAULT NULL COMMENT '秘钥',
  `msg_code` varchar(100) DEFAULT NULL COMMENT '模板',
  `banquan` varchar(50) DEFAULT NULL COMMENT '系统版权',
  `reg` tinyint(1) DEFAULT '2' COMMENT '1正常 2关闭',
  `ios1` varchar(20) DEFAULT NULL COMMENT 'ios上架版本号',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `ke_xitong` VALUES ('1', '心视灵', '0371-66666', '', '', '', '', '修改bug,完善用户体验', '1', '', 'C02557123', 'a7d5d01be215d27ee2dfbf8edaa6d086', '您的验证码是：%s。请不要把验证码泄露给其他人，有效期1分钟。', '心视灵网络', '1', '');
