<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\Work space\test\public_html/../application/admin\view\article\cat_edit.html";i:1570892025;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<form class="layui-form" action="<?php echo url('wdl_cat_edit_do'); ?>" id="form" >
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block"><span class="require-field">*</span>
      <input type="text" name="name" placeholder="请输入文章分类名称" value="<?php echo $data['name']; ?>" class="layui-input must">
    </div>
  </div>
   <div class="layui-form-item">
