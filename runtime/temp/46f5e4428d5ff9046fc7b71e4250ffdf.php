<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"F:\Work space\jinrongzixun\public_html/../application/admin\view\user\wdl_edit.html";i:1617437145;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<form class="layui-form layui-form-pane" action="<?php echo url('wdl_edit_do'); ?>" id="form" >
  <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
  <div class="layui-form-item">
    <label class="layui-form-label">手机号</label>
    <div class="layui-input-block"><span class="require-field">*</span>
      <input type="number" name="phone"  placeholder="请输入会员手机号"  value="<?php echo $data['phone']; ?>" class="layui-input must">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">登录密码</label>
    <div class="layui-input-block">
      <input type="password" name="password"  placeholder="请输入登录密码,至少6位数" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-input-block">
