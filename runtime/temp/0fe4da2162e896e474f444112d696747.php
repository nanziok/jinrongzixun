<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/home/wwwroot/admin_com/public_html/../application/admin/view/xitong/index.html";i:1570677855;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
	  ...
	  <div class="layui-tab-content" style="height: 100px;">
		<div class="layui-tab-item layui-show">
			 ...
			 <div class="layui-form-item">
				<label class="layui-form-label">是否关闭注册</label>
				<div class="layui-input-block">
