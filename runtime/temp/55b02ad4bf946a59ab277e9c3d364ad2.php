<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"F:\Work space\jinrongzixun\public_html/../application/admin\view\user\fabu_del_list.html";i:1617435736;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
	  ...
	  <div class="layui-table-tool-temp"> 
		 <div class="demoTable"> 
			 发布类型：<div class="layui-inline">
			   ...
			   &nbsp;&nbsp;发布时间：<div class="layui-inline"> <input class="layui-input" id="start_date"  placeholder="请输入"/></div>
			~~&nbsp;<div class="layui-inline"> <input class="layui-input" id="end_date" placeholder="请输入"/></div>
...
<script type="text/html" id="type_value">
	   {{#  if(d.type == 1){ }}
	      {{# layui.each(d.type_value, function(index, item){ }}
				...
				{{# }); }}
     {{# }else if(d.type == 2){ }}
      <video src="{{d.type_value}}" controls="controls" style="width: 100%;height: 100%;"></video>
     {{# }else{ }}
     --
    {{#  } }}
</script>
...
layui.use('table', function(){
 ...
 jiazai = function(){
	 table.render({
		...
		url: "<?php echo url('wdl_fabu_del_list'); ?>", //数据接口
		cols: [[ //表头
