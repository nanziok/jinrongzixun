<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"F:\Work space\jinrongzixun\public_html/../application/admin\view\article\cat.html";i:1617344275;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script type="text/html" id="search">
  <div class="layui-btn-container">
    <button class="layui-btn layui-btn-sm" lay-event="getCheckData">添加文章分类</button>
  </div>
</script>
<script>
var jiazai;
...
layui.use('table', function(){
 ...
 jiazai = function(){
	 table.render({
		...
		cols: [[ //表头
		  {field: 'id', title: '文章分类ID'},
		  {field: 'name', title: '文章分类'},
		  {field: 'count', title: '文章个数'},
		  {field: 'desc', title: '备注'},
  ...
  table.on('tool(test)', function(obj){
	  switch(obj.event){
		case 'edit_id':
		open_window(obj.data.id,"wdl_cat_edit",'编辑文章分类','40%');
		break;
		case 'del':
   ...
   table.on('toolbar(test)', function(obj){
	  switch(obj.event){
		case 'getCheckData':
		open_window(0,"wdl_cat_add",'添加文章分类','40%');
		break;
	  };
  });
