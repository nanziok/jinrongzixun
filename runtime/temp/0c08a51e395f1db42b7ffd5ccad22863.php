<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"F:\Work space\jinrongzixun\public_html/../application/admin\view\service\wdl_add_cat.html";i:1619157164;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form layui-form-pane" method="post" id="form" style="margin-top: 10px;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block"><span class="require-field">*</span>
            <input type="text" name="name" placeholder="请输入咨询师名称" class="layui-input must">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">头像</label>
        <div class="layui-input-block"><span class="require-field">*</span>
            <input type="text" name="image" placeholder="请上传头像" id="image_upload" class="layui-input must layui-hide">
            <button type="button" class="layui-btn" id="uploadimage">
                <i class="layui-icon">&#xe67c;</i>上传图片
            </button>
            <p style="margin-top: 10px"><img class="layui-upload-img" id="image-preview" /></p>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="tags" placeholder="回车生成标签" id="jquery-inputtags" class="" />
            </div>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="width:60%;z-index:0;"><span class="require-field">*</span>
            <input class="layui-input must" placeholder="请输入价格" name="price" value="" />
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">排序</label>
        <div class="layui-input-block" style="width:60%;z-index:0;"><span class="require-field">*</span>
            <input class="layui-input must" placeholder="请输入排序数字" name="weigh" value="10" />
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">状态</label>
        <div class="layui-input-block" style="width:60%;z-index:0;"><span class="require-field">*</span>
            <input type="checkbox" class="layui-form-switch" lay-skin="switch" value="1" placeholder="是否显示" lay-text="显示|隐藏" name="status" value="10" checked/>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
